...
if ($_SESSION['type'] == 0) {
    ...
    if($_POST){
        ...
        $SQL = "SELECT UserID FROM users WHERE Usuario = '$user'";
        ...
        if($num > 0){
            ...
            $SQL = "INSERT INTO users (Usuario, Clave, Tipo) VALUES ('$user', '$pass_c', $type)";
            $res = $mysqli->query($SQL);
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input name = "type" class="form-control" id="inputPasswordConfirm" type="number" placeholder="Rol" />
                                                        <label for="inputPasswordConfirm">Rol</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-4 mb-0">
